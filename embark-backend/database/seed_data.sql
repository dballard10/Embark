...
BEGIN
    ...
    -- Insert rewards (one for each tier)
    INSERT INTO rewards (id, name, description, rarity_tier, rarity_stars, image_url) VALUES
    ('11111111-1111-1111-1111-111111111111', 'Bronze Compass', 'A simple compass for new adventurers', 1, 1, NULL),
    ('22222222-2222-2222-2222-222222222222', 'Silver Blade', 'A well-crafted sword for seasoned warriors', 2, 2, NULL),
    ('33333333-3333-3333-3333-333333333333', 'Golden Shield', 'An enchanted shield that deflects harm', 3, 3, NULL),
    ('44444444-4444-4444-4444-444444444444', 'Diamond Amulet', 'A precious amulet radiating power', 4, 4, NULL),
    ('55555555-5555-5555-5555-555555555555', 'Obsidian Crown', 'A legendary crown worn by masters', 5, 5, NULL),
    ('66666666-6666-6666-6666-666666666666', 'Phoenix Essence', 'The mythical essence of a phoenix', 6, 6, NULL);
