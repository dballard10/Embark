...
function ShopPage() {
  ...
  const getRarityColor = (tier: number) => {
    switch (tier) {
      ...
      case 2:
        return "from-green-600/20 to-green-700/20 border-green-500/40";
      case 3:
        return "from-blue-600/20 to-blue-700/20 border-blue-500/40";
      case 4:
        return "from-purple-600/20 to-purple-700/20 border-purple-500/40";
      case 5:
        return "from-orange-600/20 to-orange-700/20 border-orange-500/40";
      case 6:
        return "from-red-600/20 to-red-700/20 border-red-500/40";
      default:
        return "from-gray-600/20 to-gray-700/20 border-gray-500/40";
    }
  };
  ...
  return (
    <div className="game-container">
      ...
      {/* Shop Header */}
      <div className="bg-gradient-to-r from-amber-900/40 via-orange-900/40 to-amber-900/40 border-b-2 border-amber-600/30 sticky top-[72px] z-10 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-amber-600 to-orange-600 flex items-center justify-center shadow-lg">
                <IconShoppingBag size={32} className="text-white" stroke={2} />
              </div>
              <div>
                ...
                <p className="text-amber-300/80 text-sm">
                  Purchase items with your hard-earned glory
                </p>
              </div>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute top-3 right-3 z-10">
                    <div className="flex items-center gap-0.5 px-2 py-1 rounded-lg bg-black/40 backdrop-blur-sm border border-white/20">
